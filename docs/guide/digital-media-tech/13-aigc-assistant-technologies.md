...
::: example 短视频批量生成案例
**项目背景**：某品牌需要为不同平台制作 100 条产品宣传短视频
...
::: success 核心要点回顾
AIGC 技术正在深刻改变数字媒体制作的各个环节，从剧本创作到视觉生成，从智能剪辑到内容分发，AI 正在成为创作者不可或缺的助手。
:::
...
- [Runway ML 教程](https://runwayml.com/)

**社区资源**
- [AIGC 创作者社区](https://www.reddit.com/r/artificial/)
- [Prompt 工程指南](https://www.promptingguide.ai/)
- [AI 工具评测网站](https://www.futurepedia.io/)

**行业报告**
- [AIGC 产业发展报告](https://example.com/report)
- [AI 创作伦理指南](https://example.com/ethics)
- [版权法律更新](https://example.com/legal)
:::
