...
| 设备类型 | 运动范围 | 特点 | 注意事项 |
|----------|----------|------|----------|
| **摇臂** | 4-40 米伸缩 | 配轨道或轮子实现多维度运动 | 需要专业操作员 |
| **斯坦尼康** | 自由移动 | 配广角镜头，画面稳定 | 无线传输可能被干扰 |
| **轨道** | 直线/弧线 | 普通轨道、电控轨道 | 铺设时间较长 |
| **飞猫** | 高空索道 | 2 维/3 维可升降系统 | 安全要求高 |
...
::: info 参考资料
本部分参考 B 站视频：[常用应用场景机位架设分析【我是导播】](https://www.bilibili.com/video/BV1Ya411u7ET/)
:::
